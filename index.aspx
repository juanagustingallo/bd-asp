<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="BiggData.index" %>
<!DOCTYPE html>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-sm-8 main-menu text-right">
                                    ...
                                    <ul class="menu-first">
                                        ...
                                        <li><a href="http://plus.facebook.com/+templatemo" class="external" target="_parent" rel="nofollow">Log in</a></li> 
                        ...
                        <ul class="slides">
                            ...
                            <li>
                                ...
                                <div class="slider-caption visible-md visible-lg">
                                    ...
                                    <a href="#" class="slider-btn">Ver portfolio</a>
                                </div>
                            </li>
                        </ul>
                    </div> <!-- /.flexslider -->
                ...
                <div class="row">
                        ...
                        <div class="service-item" id="service-1">
                            ...
                            <div class="service-content">
                                <div class="inner-service">
                                   ...
                                   <p>Controle entradas, salidas, stock de su mercadería</p> 
                                </div>
                            </div> <!-- /.service-content -->
                        </div> <!-- /#service-1 -->
                    </div> <!-- /.col-md-3 -->
                    <div class="col-md-3 col-sm-6">
                        <div class="service-item" id="service-2">
                            ...
                            <div class="service-content">
                                <div class="inner-service">
                                   <h3>Localización de productos</h3>
                                   <p>Controle los movimientos de sus productos</p> 
                                </div>
                            </div> <!-- /.service-content -->
                        </div> <!-- /#service-1 -->
                    </div> <!-- /.col-md-3 -->
                    <div class="col-md-3 col-sm-6">
                        <div class="service-item" id="service-3">
                            ...
                            <div class="service-content">
                                <div class="inner-service">
                                   <h3>Seguimiento de procesos</h3>
                                   <p>Obtenga toda la información de su negocio en tiempo real desde cualquier parte del mundo.</p> 
                                </div>
                            </div> <!-- /.service-content -->
                        </div> <!-- /#service-1 -->
                    </div> <!-- /.col-md-3 -->
                        ...
                        <div class="service-item" id="service-4">
                            ...
                            <div class="service-content">
                                <div class="inner-service">
                                   ...
                                   <p>Visualice estadísticas acerca de sus procesos para tomar decisiones.</p> 
                                </div>
                            </div> <!-- /.service-content -->
                        </div> <!-- /#service-1 -->
                    </div> <!-- /.col-md-3 -->
        ...
        <div class="content-section" id="portfolio">
            <div class="container">
                <div class="row">
                    <div class="heading-section col-md-12 text-center">
                        <h2>Portfolio</h2>
                        <p>Trabajos realizados para nuestros clientes</p>
                    </div> <!-- /.heading-section -->
                </div> <!-- /.row -->
                <div class="row">
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            ...
                            <div class="portfolio-overlay">
                                <h3>Control de biblioteca UAI</h3>
                                <p>La Universidad Abierta Interamericana utiliza nuestro sistema para gestionar su biblioteca</p>
        ...
        <div class="content-section" id="our-team">
            <div class="container">
                <div class="row">
                    <div class="heading-section col-md-12 text-center">
                        <h2>Equipo</h2>
                        <p>Estamos unidos para su éxito</p>
                    </div> <!-- /.heading-section -->
                </div> <!-- /.row -->
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-7 col-sm-6">                        
                        <ul class="contact-info">
                            <li>Teléfono: 1153866668</li>
                            <li>Email: <a href="mailto:ventas@biggdata.com.ar">Ventas@BiggData.com.ar</a></li>                            
                        </ul>
                    ...
                    <div class="col-md-5 col-sm-6">
                        <div class="contact-form">
                            <form method="post" name="contactform" id="contactform">
                                ...
                                <input type="submit" class="mainBtn" id="submit" value="Enviar consulta">
                            </form>
                        </div> <!-- /.contact-form -->
                    </div> <!-- /.col-md-5 -->
                </div> <!-- /.row -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-xs-12 text-left">
                        <span>Copyright &copy; 2017 Bigg Data</span>
                  </div> <!-- /.text-center -->
                    <div class="col-md-4 hidden-xs text-right">
                        <a href="#top" id="go-top">Volver arriba</a>
                    </div> <!-- /.text-center -->
                </div> <!-- /.row -->
            </div> <!-- /.container -->
        </div> <!-- /#footer -->
